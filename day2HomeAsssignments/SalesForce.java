...
public class SalesForce extends ProjectSpecificMethod{
	...
	public void salesForce() throws InterruptedException {
		...
		WebElement legalEntity = driver.findElement(By.xpath("//span[contains(text(),'Legal Entities')]/following::span[contains(text(),'Legal Entities List')]"));
		...
		wait.until(ExpectedConditions.elementToBeClickable(newLegalEntity));
